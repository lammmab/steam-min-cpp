...
#ifndef enums_5fclientserver_2eproto_2epb_2eh
#define enums_5fclientserver_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_enums_5fclientserver_2eproto;
}  // extern "C"
enum EClientPersonaStateFlag : int;
extern const uint32_t EClientPersonaStateFlag_internal_data_[];
enum ECodecUsagePlatform : int;
extern const uint32_t ECodecUsagePlatform_internal_data_[];
enum ECodecUsageReason : int;
extern const uint32_t ECodecUsageReason_internal_data_[];
enum EMsg : int;
...
namespace protobuf {
template <>
internal::EnumTraitsT<::EClientPersonaStateFlag_internal_data_>
    internal::EnumTraitsImpl::value<::EClientPersonaStateFlag>;
template <>
internal::EnumTraitsT<::ECodecUsagePlatform_internal_data_>
    internal::EnumTraitsImpl::value<::ECodecUsagePlatform>;
template <>
internal::EnumTraitsT<::ECodecUsageReason_internal_data_>
    internal::EnumTraitsImpl::value<::ECodecUsageReason>;
template <>
internal::EnumTraitsT<::EMsg_internal_data_>
    internal::EnumTraitsImpl::value<::EMsg>;
template <>
internal::EnumTraitsT<::EMsgClanAccountFlags_internal_data_>
    internal::EnumTraitsImpl::value<::EMsgClanAccountFlags>;
template <>
internal::EnumTraitsT<::ESteamReviewScore_internal_data_>
    internal::EnumTraitsImpl::value<::ESteamReviewScore>;
}  // namespace protobuf
}  // namespace google
...
extern const uint32_t EMsg_internal_data_[];
inline constexpr EMsg EMsg_MIN =
    static_cast<EMsg>(0);
inline constexpr EMsg EMsg_MAX =
    static_cast<EMsg>(12301);
inline bool EMsg_IsValid(int value) {
  return ::google::protobuf::internal::ValidateEnum(value, EMsg_internal_data_);
}
inline constexpr int EMsg_ARRAYSIZE = 12301 + 1;
...
inline bool EMsg_Parse(
    ::absl::string_view name, EMsg* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<EMsg>(EMsg_descriptor(), name,
                                           value);
}
enum EClientPersonaStateFlag : int {
...
extern const uint32_t EClientPersonaStateFlag_internal_data_[];
inline constexpr EClientPersonaStateFlag EClientPersonaStateFlag_MIN =
    static_cast<EClientPersonaStateFlag>(1);
inline constexpr EClientPersonaStateFlag EClientPersonaStateFlag_MAX =
    static_cast<EClientPersonaStateFlag>(16384);
inline bool EClientPersonaStateFlag_IsValid(int value) {
  return ::google::protobuf::internal::ValidateEnum(value, EClientPersonaStateFlag_internal_data_);
}
inline constexpr int EClientPersonaStateFlag_ARRAYSIZE = 16384 + 1;
...
inline bool EClientPersonaStateFlag_Parse(
    ::absl::string_view name, EClientPersonaStateFlag* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<EClientPersonaStateFlag>(EClientPersonaStateFlag_descriptor(), name,
                                           value);
}
enum EMsgClanAccountFlags : int {
...
extern const uint32_t EMsgClanAccountFlags_internal_data_[];
inline constexpr EMsgClanAccountFlags EMsgClanAccountFlags_MIN =
    static_cast<EMsgClanAccountFlags>(1);
inline constexpr EMsgClanAccountFlags EMsgClanAccountFlags_MAX =
    static_cast<EMsgClanAccountFlags>(16);
inline bool EMsgClanAccountFlags_IsValid(int value) {
  return 0 <= value && value <= 16 && ((65814u >> value) & 1) != 0;
}
inline constexpr int EMsgClanAccountFlags_ARRAYSIZE = 16 + 1;
...
inline const ::std::string& EMsgClanAccountFlags_Name(EMsgClanAccountFlags value) {
  return ::google::protobuf::internal::NameOfDenseEnum<EMsgClanAccountFlags_descriptor, 1, 16>(
      static_cast<int>(value));
}
inline bool EMsgClanAccountFlags_Parse(
    ::absl::string_view name, EMsgClanAccountFlags* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<EMsgClanAccountFlags>(EMsgClanAccountFlags_descriptor(), name,
                                           value);
}
enum ESteamReviewScore : int {
...
extern const uint32_t ESteamReviewScore_internal_data_[];
inline constexpr ESteamReviewScore ESteamReviewScore_MIN =
    static_cast<ESteamReviewScore>(0);
inline constexpr ESteamReviewScore ESteamReviewScore_MAX =
    static_cast<ESteamReviewScore>(9);
inline bool ESteamReviewScore_IsValid(int value) {
  return 0 <= value && value <= 9;
}
inline constexpr int ESteamReviewScore_ARRAYSIZE = 9 + 1;
...
inline const ::std::string& ESteamReviewScore_Name(ESteamReviewScore value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ESteamReviewScore_descriptor, 0, 9>(
      static_cast<int>(value));
}
inline bool ESteamReviewScore_Parse(
    ::absl::string_view name, ESteamReviewScore* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<ESteamReviewScore>(ESteamReviewScore_descriptor(), name,
                                           value);
}
enum ECodecUsagePlatform : int {
...
extern const uint32_t ECodecUsagePlatform_internal_data_[];
inline constexpr ECodecUsagePlatform ECodecUsagePlatform_MIN =
    static_cast<ECodecUsagePlatform>(0);
inline constexpr ECodecUsagePlatform ECodecUsagePlatform_MAX =
    static_cast<ECodecUsagePlatform>(4);
inline bool ECodecUsagePlatform_IsValid(int value) {
  return 0 <= value && value <= 4;
}
inline constexpr int ECodecUsagePlatform_ARRAYSIZE = 4 + 1;
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL ECodecUsagePlatform_descriptor();
template <typename T>
const ::std::string& ECodecUsagePlatform_Name(T value) {
  static_assert(::std::is_same<T, ECodecUsagePlatform>::value ||
                    ::std::is_integral<T>::value,
                "Incorrect type passed to ECodecUsagePlatform_Name().");
  return ECodecUsagePlatform_Name(static_cast<ECodecUsagePlatform>(value));
}
template <>
inline const ::std::string& ECodecUsagePlatform_Name(ECodecUsagePlatform value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ECodecUsagePlatform_descriptor, 0, 4>(
      static_cast<int>(value));
}
inline bool ECodecUsagePlatform_Parse(
    ::absl::string_view name, ECodecUsagePlatform* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<ECodecUsagePlatform>(ECodecUsagePlatform_descriptor(), name,
                                           value);
}
enum ECodecUsageReason : int {
...
extern const uint32_t ECodecUsageReason_internal_data_[];
inline constexpr ECodecUsageReason ECodecUsageReason_MIN =
    static_cast<ECodecUsageReason>(0);
inline constexpr ECodecUsageReason ECodecUsageReason_MAX =
    static_cast<ECodecUsageReason>(4);
inline bool ECodecUsageReason_IsValid(int value) {
  return 0 <= value && value <= 4;
}
inline constexpr int ECodecUsageReason_ARRAYSIZE = 4 + 1;
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL ECodecUsageReason_descriptor();
template <typename T>
const ::std::string& ECodecUsageReason_Name(T value) {
  static_assert(::std::is_same<T, ECodecUsageReason>::value ||
                    ::std::is_integral<T>::value,
                "Incorrect type passed to ECodecUsageReason_Name().");
  return ECodecUsageReason_Name(static_cast<ECodecUsageReason>(value));
}
template <>
inline const ::std::string& ECodecUsageReason_Name(ECodecUsageReason value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ECodecUsageReason_descriptor, 0, 4>(
      static_cast<int>(value));
}
inline bool ECodecUsageReason_Parse(
    ::absl::string_view name, ECodecUsageReason* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<ECodecUsageReason>(ECodecUsageReason_descriptor(), name,
                                           value);
}
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::EMsg>() {
  return ::EMsg_descriptor();
}
template <>
struct is_proto_enum<::EClientPersonaStateFlag> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::EClientPersonaStateFlag>() {
  return ::EClientPersonaStateFlag_descriptor();
}
template <>
struct is_proto_enum<::EMsgClanAccountFlags> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::EMsgClanAccountFlags>() {
  return ::EMsgClanAccountFlags_descriptor();
}
template <>
struct is_proto_enum<::ESteamReviewScore> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::ESteamReviewScore>() {
  return ::ESteamReviewScore_descriptor();
}
template <>
struct is_proto_enum<::ECodecUsagePlatform> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::ECodecUsagePlatform>() {
  return ::ECodecUsagePlatform_descriptor();
}
template <>
struct is_proto_enum<::ECodecUsageReason> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::ECodecUsageReason>() {
...
#endif  // enums_5fclientserver_2eproto_2epb_2eh
