...
namespace Steam::Internal::Enums
{
	...
	enum class EActivationCodeClass : uint32_t
	{
		WonCDKey = 0,
		ValveCDKey = 1,
		Doom3CDKey = 2,
	...
	enum class ERegionCode : unsigned char
	{
		USEast = 0x00,
		USWest = 0x01,
		SouthAmerica = 0x02,
	...
	// Flags enum (bitmask values)
	enum class EUCMFilePrivacyState
	{
		Invalid = -1,
		Private = 2,
		FriendsOnly = 4,
	...
	enum class EPublishedFileInappropriateProvider
	{
		Invalid = 0,
		Google = 1,
		Amazon = 2,
	};
	enum class EPublishedFileInappropriateResult
	{
		NotScanned = 0,
		VeryUnlikely = 1,
		Unlikely = 30,
	...
	enum class EChatRoomGroupType
	{
		Default = 0,
		Unmoderated = 1,
	};
	enum class EChatroomNotificationLevel
	{
		Invalid = 0,
		None = 1,
		MentionMe = 2,
	...
	enum class EChatRoomMemberStateChange
	{
		Invalid = 0,
		Joined = 1,
		Parted = 2,
	...
	// Flags enum (bitmask values)
	enum class EChatRoomGroupPermissions
	{
		Default = 0,
		Valid = 1,
		CanInvite = 2,
	...
	enum class EChatRoomGroupAction
	{
		Default = 0,
	...
	enum class ETradeOfferConfirmationMethod
	{
		Invalid = 0,
		Email = 1,
		MobileApp = 2,
	...
	enum class ESteamRealm
	{
		Unknown = 0,
		SteamGlobal = 1,
		SteamChina = 2,
	};
	enum class ELauncherType
	{
		Default = 0,
		PerfectWorld = 1,
		Nexon = 2,
	...
	enum class EMobileConfirmationAction
	{
		None = 0,
		Allow = 1,
		Cancel = 2,
	};
	enum class EMobileConfirmationType
	{
		Invalid = 0,
		Test = 1,
		Trade = 2,
	...
	enum class EUdpPacketType : unsigned char
	{
		Invalid = 0,
		ChallengeReq = 1,
		Challenge = 2,
