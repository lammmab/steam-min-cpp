...
using ProtoHandlerFn =
    void (*)(Steam::Messaging::CMClient&,
             const Steam::Messaging::Packets::PacketClientMsgProtobuf&);

using MsgHandlerFn = void (*)(Steam::Messaging::CMClient&,
                              const Steam::Messaging::Packets::PacketMsg&);
